...
class templateController extends Controller
{
    ...
    function cvCreate($id, $id2){
      ...
      DB::table('skills')->insert(['skill_name' => 'Your skill', 'skill_level' => 'skill level', 'cv_id' => $userNewCvId]);
      DB::table('skills')->insert(['skill_name' => 'Your skill', 'skill_level' => 'skill level', 'cv_id' => $userNewCvId]);
      DB::table('awards')->insert(['award_text' => 'Some information about your awards', 'cv_id' => $userNewCvId]);
